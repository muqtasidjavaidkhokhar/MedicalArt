describe('contact', function () {
    it('contact', function () {
        cy.visit('http://127.0.0.1:8000/contact/').then(() => {
        ...
        cy.get(':nth-child(4) > li').contains('Friday');
        cy.get(':nth-child(6) > li').contains('Saturday');
        cy.get(':nth-child(8) > li').contains('Sunday');
        cy.get('.emergency-box > h2.d-flex').contains('Emergency');
        cy.get('.emergency-box > .call-btn > .d-flex').contains('+34 586 778 8892');
